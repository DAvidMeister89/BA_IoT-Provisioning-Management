...
\begin{figure}[H]
\includegraphics[scale=0.5]{../02_Analyse/images/lwm2m/registration_diagram.png}
\caption{LwM2M Stack\cite{LwM2MInterfaces}}
\end{figure}
Resource discovery
...
\begin{figure}[H]
\includegraphics[scale=0.5]{../02_Analyse/images/lwm2m/command_diagram.png}
\caption{LwM2M Stack\cite{LwM2MInterfaces}}
\end{figure}
...
\begin{figure}[H]
\includegraphics[scale=0.5]{../02_Analyse/images/lwm2m/report_diagram.png}
\caption{LwM2M Stack\cite{LwM2MInterfaces}}
\end{figure}
Observing
