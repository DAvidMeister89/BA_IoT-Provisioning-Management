...
Ein Bestandteil des Maintenance Management ist das Asset-Management. Hier werden alle Gerätedaten, Hanbücher, Garantien und andere relevanten Daten zum Gerät gespeichert.\cite{MainAsset}

Asset-Management
Verwaltung von Wartungs- und Inspektionsplänen 
Updates



Bei all den Millionen Geräten, ist die Wartung ein wichtiger Bestandteil. Die Techniken sind meist sehr neu und werden laufend weiterentwickelt. Dadurch veröffentlicht der IoT-Gerätehersteller ständig neue Updates und Patches, um neue Funktionen und Sicherheitsupdates einzuspielen. Doch wie behält man den Überblick bei all den Geräten und Softwareständen.\newline\newline
Wichtig ist vorallem, dass man



\subsubsection{Maintenance und Update im IoT-Bereich}
Da es bei IoT-Geräten häufig um Sensoren handelt, welche auch an aussenbereichen platziert werden können, ist ein Wartungsmanagement sehr wichtig. Die Sensoren sind durch die Umwelt härteren Bedingungen ausgesetzt als ein normaler Computer. Daher ist eine Reparatur- und Wartungsempfehlung im Management ein wichtiger Bestandteil. Das Management gibt Empfehlungen, wann ein Gerät gewartet werden muss, damit der Techniker genau weiss, wann er Vorort sein muss.\newline\newline
Durch die vielen Software Updates bei der hohen Anzahl an Geräten, muss es eine automatische Software Update Funktion geben. Von Hand kann diese hohe Anzahl an Geräten gar nicht mehr bewältigt werden. So gibt man pro Sensor den gewünschten Softwarestand frei und die Managementumgebung spielt diese automatisch auf die jeweiligen Sensoren. Bei Problemen wird der Administrator benachrichtigt und kann eingreifen. \newline \newline
